...
export interface Links1 {
  ...
  attractions:
    | AttractionsEntityOrVenuesEntityOrSelfOrFirstOrNextOrLast[]
    | null;
...
export interface ExternalLinks {
  youtube?:
    | TwitterEntityOrFacebookEntityOrWikiEntityOrInstagramEntityOrHomepageEntityOrYoutubeEntityOrItunesEntityOrLastfmEntity[]
    | null;
  twitter?:
    | TwitterEntityOrFacebookEntityOrWikiEntityOrInstagramEntityOrHomepageEntityOrYoutubeEntityOrItunesEntityOrLastfmEntity[]
    | null;
